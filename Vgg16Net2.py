...
# 导入卷积计算类定义
from class_convd import CConv2d

from class_linear import Linear
...
class Vgg16_net(nn.Module):
    def __init__(self):
        ...
        self.layer3=nn.Sequential(
            ...
            CConv2d(in_channels=256,out_channels=256,kernel_size=3,stride=1,padding=1),  #(8-3+2)/1+1=8   8*8*256
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
